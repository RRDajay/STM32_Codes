...
void gpio_config_output_pin(GPIO_TypeDef *port, uint8_t pinNumber,
  ...
  if (pinNumber >= 8) {
    ...
    case OUTPUT_PP:
      ...
      port->CRH |= ((OUTPUT_PP << (pinPos[pinNumber] + 2)) |
                    (pinSpeed << pinPos[pinNumber]));
      break;

    case OUTPUT_OD:
      port->CRH &= ~((3 << (pinPos[pinNumber] + 2)) | (3 << pinPos[pinNumber]));
      port->CRH |= ((OUTPUT_OD << (pinPos[pinNumber] + 2)) |
                    (pinSpeed << pinPos[pinNumber]));
      break;

    case OUTPUT_AF_PP:
      port->CRH &= ~((3 << (pinPos[pinNumber] + 2)) | (3 << pinPos[pinNumber]));
      port->CRH |= ((OUTPUT_AF_PP << (pinPos[pinNumber] + 2)) |
                    (pinSpeed << pinPos[pinNumber]));
      break;

    case OUTPUT_AF_OD:
      port->CRH &= ~((3 << (pinPos[pinNumber] + 2)) | (3 << pinPos[pinNumber]));
      port->CRH |= ((OUTPUT_AF_OD << (pinPos[pinNumber] + 2)) |
                    (pinSpeed << pinPos[pinNumber]));
      break;
    ...
    case OUTPUT_PP:
      ...
      port->CRL |= ((OUTPUT_PP << (pinPos[pinNumber] + 2)) |
                    (pinSpeed << pinPos[pinNumber]));
      break;

    case OUTPUT_OD:
      port->CRL &= ~((3 << (pinPos[pinNumber] + 2)) | (3 << pinPos[pinNumber]));
      port->CRL |= ((OUTPUT_OD << (pinPos[pinNumber] + 2)) |
                    (pinSpeed << pinPos[pinNumber]));
      break;

    case OUTPUT_AF_PP:
      port->CRL &= ~((3 << (pinPos[pinNumber] + 2)) | (3 << pinPos[pinNumber]));
      port->CRL |= ((OUTPUT_AF_PP << (pinPos[pinNumber] + 2)) |
                    (pinSpeed << pinPos[pinNumber]));
      break;

    case OUTPUT_AF_OD:
      port->CRL &= ~((3 << (pinPos[pinNumber] + 2)) | (3 << pinPos[pinNumber]));
      port->CRL |= ((OUTPUT_AF_OD << (pinPos[pinNumber] + 2)) |
                    (pinSpeed << pinPos[pinNumber]));
      break;
...
void gpio_config_input_pin(GPIO_TypeDef *port, uint8_t pinNumber,
  ...
  if (pinNumber >= 8) {
    ...
    case ANALOG_MODE:
      port->CRH &= ~((3 << (pinPos[pinNumber] + 2)) | (3 << pinPos[pinNumber]));
      port->CRH |=
          ((ANALOG_MODE << (pinPos[pinNumber] + 2)) | (0 << pinPos[pinNumber]));
      break;

    case FLOATING_INPUT:
      port->CRH &= ~((3 << (pinPos[pinNumber] + 2)) | (3 << pinPos[pinNumber]));
      port->CRH |= ((FLOATING_INPUT << (pinPos[pinNumber] + 2)) |
                    (0 << pinPos[pinNumber]));
      break;
    ...
    case INPUT_PU_PD:
      port->CRH &= ~((3 << (pinPos[pinNumber] + 2)) | (3 << pinPos[pinNumber]));
      port->CRH |=
          ((INPUT_PU_PD << (pinPos[pinNumber] + 2)) | (0 << pinPos[pinNumber]));
      break;
    ...
    case FLOATING_INPUT:
      port->CRL &= ~((3 << (pinPos[pinNumber] + 2)) | (3 << pinPos[pinNumber]));
      port->CRL |= ((FLOATING_INPUT << (pinPos[pinNumber] + 2)) |
                    (0 << pinPos[pinNumber]));
      break;
