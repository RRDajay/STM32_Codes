...
void gpio_clock_enable_portb(void) {(RCC->APB2ENR |= 1 << RCC_APB2ENR_IOPBEN_Pos);}
void gpio_clock_enable_portc(void) {(RCC->APB2ENR |= 1 << RCC_APB2ENR_IOPCEN_Pos);}
void gpio_clock_enable_portd(void) {(RCC->APB2ENR |= 1 << RCC_APB2ENR_IOPDEN_Pos);}
void gpio_clock_enable_porte(void) {(RCC->APB2ENR |= 1 << RCC_APB2ENR_IOPEEN_Pos);}
